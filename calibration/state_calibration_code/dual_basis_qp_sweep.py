...
# use this file to find the qp angle that produces the correct phase shift for a given state by minimizing counts in the 2 bases
# you expect counts to be minimized in
