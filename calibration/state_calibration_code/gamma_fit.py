...
# this file plots a collection of gamma data generated in gamma_determination (you need to copy each individual output file into 
# as csv file and name it all_gamma_data_{date}_{trial}_for_{stateName}) and outputs the QP angle at which the goalGamma occurs.
